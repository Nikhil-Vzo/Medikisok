  ...
  return (
    <div className="flex-1 bg-[#F7FAF8] min-h-screen selection:bg-emerald-100 selection:text-emerald-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        <div className="max-w-xl mx-auto text-center space-y-4 mb-8 sm:mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-5xl mx-auto">
          ...
          <Link
            href="/login/patient"
            className="group p-5 sm:p-7 rounded-xl bg-white border border-slate-200 hover:border-emerald-600 hover:bg-emerald-50/20 transition-all flex flex-col justify-between min-h-[220px] sm:min-h-[260px] shadow-sm hover:shadow-md"
          >
          ...
          <Link
            href="/desk"
            className="group p-5 sm:p-7 rounded-xl bg-white border border-slate-200 hover:border-teal-600 hover:bg-teal-50/20 transition-all flex flex-col justify-between min-h-[220px] sm:min-h-[260px] shadow-sm hover:shadow-md"
          >
            <div className="space-y-4">
          ...
          <Link
            href="/login/admin"
            className="group p-5 sm:p-7 rounded-xl bg-white border border-slate-200 hover:border-indigo-600 hover:bg-indigo-50/20 transition-all flex flex-col justify-between min-h-[220px] sm:min-h-[260px] shadow-sm hover:shadow-md"
          >
            <div className="space-y-4">
