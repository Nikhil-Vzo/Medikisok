      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            {/* App Store / Direct Launch Badges */}
            <div className="flex items-center gap-2 pt-2">
              {/* Google Play */}
              <Link
                href="/kiosk"
                className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#27427d] hover:bg-[#335399] border border-white/20 text-white transition-all shadow-xs"
              >
                <svg className="w-4 h-4 fill-current shrink-0 text-white" viewBox="0 0 24 24">
                  <path d="M3.609 1.814L13.792 12 3.61 22.186a2.03 2.03 0 0 1-.61-1.46V3.274c0-.566.224-1.09.609-1.46zm11.604 11.607l2.253 2.253-12.04 6.877 9.787-9.13zm2.253-2.842l-2.253 2.253L5.426 3.695l12.04 6.884zm1.095 1.095l2.766 1.58c.954.545.954 1.433 0 1.979l-2.766 1.58-2.072-2.07 2.072-2.069z" />
                </svg>
              ...
              >
                <svg className="w-4 h-4 fill-current shrink-0 text-white" viewBox="0 0 24 24">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.62-.75 1.04-1.8 0.92-2.85-.9.04-1.99.6-2.64 1.35-.57.65-1.07 1.72-.94 2.74 1.01.08 2.03-.5 2.66-1.24z" />
                </svg>
                <div className="text-left leading-none">
                  <span className="text-[9px] uppercase tracking-wider block opacity-75">Download on</span>
